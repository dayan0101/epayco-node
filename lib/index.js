...
function Epayco(options) {
  ...
  this.version = (options.version ? options.version : "v1").toLowerCase();
  this.endpoint = "https://api.secure.epayco.io";
  ...
  if (this.version === "v2") {
    ...
    const Token = require("./v2/token");
    const Plans = require("./v2/plans");
    const Customers = require("./v2/customers");
    const Subscription = require("./v2/subscriptions");
